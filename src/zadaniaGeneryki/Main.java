...
public class Main {
    ...
    private static void testZadanie5() {
        Integer[] integerArray = {1, 2, 3};
    ...
    private static void testZadanie6() {
        Integer[] integerArray = {1, 2, 3};
    ...
    private static void testZadanie7() {
    ...
    private static void testZadanie8() {
    ...
    private static void testZadanie9() {
    ...
    private static void testZadanie10() {
